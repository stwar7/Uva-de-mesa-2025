...
Los valores iniciales de Hue (°) del raquis mostraron una fuerte relación negativa con la intensidad del pardeamiento después de 10 días a 0°C . Indicando que valores de Hue (°) más bajos (desplazamiento hacia el amarillo) están asociado con un mayor oscurecimiento durante el almacenamiento en poscosecha. 

El Contenido Relativo de Agua (CRA), mostró una relación inversa consistente con el pardeamiento del raquis en los  2 cultivares evaluados. Durante el almacenamiento 10 días a 0 °, la relación fuerte en Allison (R² = 0.85), Sweet Celebration  (R² = 0.78) 

```{python}
#| echo: true
#| code-fold: true
#| fig-cap: 'Figura 1. Relacion de Hue (°) en cosecha  y el Hue(°) final despues de almacenamiento ( 10 dias a 0°C)'
...
#| echo: true
#| code-fold: true
#| fig-cap: 'Figura 2. Relacion de acuerdo CRA (%) y el pardeameinto del raquis despues de almacenamiento ( 10 dias a 0°C)'
...
#| echo: true
#| code-fold: true
#| fig-cap: 'Figura 3. Almacenamiento comercial en poscosecha de acuerdo color inical  de raquis en cosecha'
# 1. Cargar datos
# ===================================================
